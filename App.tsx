    ...
    useEffect(() => {
        const syncEverything = async () => {
            ...
            try {
                ...
                if (marketOrderRes.ok) setMarketOrders(await marketOrderRes.json());
