        ...
        <div className="flex flex-col h-full bg-black overflow-hidden relative">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-2 bg-gray-900 border-t border-gray-800 flex flex-col gap-1 z-40">
                <div className="text-right px-1">
                    <p className="text-[12px] text-lemon font-black tracking-tighter leading-none uppercase">Est. Total: ₹{total.toFixed(0)}</p>
                </div>
                <button 
                    onClick={handleSendToKitchen} 
                    className="w-full bg-lemon text-black font-black py-3 rounded-xl text-[11px] uppercase active:scale-95 disabled:opacity-20 shadow-xl shadow-lemon/10 flex items-center justify-center gap-2"
