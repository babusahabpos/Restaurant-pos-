                                ...
                                <tr key={user.id} className="hover:bg-white/5 transition-colors group">
                                    ...
                                    <td className="px-6 py-5 text-right whitespace-nowrap">
                                        <div className="flex justify-end gap-2">
                                            <button onClick={() => setEditUser(user)} className="text-[9px] font-black uppercase bg-blue-600 text-white px-3 py-1.5 rounded-lg active:scale-95">Edit Profile</button>
