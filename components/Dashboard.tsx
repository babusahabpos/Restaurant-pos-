                    ...
                    {allPendingOrders.length > 0 ? (
                        allPendingOrders.sort((a,b) => b.timestamp.getTime() - a.timestamp.getTime()).map(order => (
                            <div key={order.id} className="bg-black/50 border border-gray-800 p-6 rounded-[2.5rem] flex flex-col gap-6 hover:border-lemon/20 transition-all group relative">
                                ...
                                <div className="flex flex-row flex-wrap gap-2 items-center justify-start pt-4 border-t border-white/5 overflow-x-auto no-scrollbar">
                                    <button onClick={() => onPrintKOT(order)} className="flex-1 min-w-[80px] flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-gray-800 text-lemon border border-lemon/10 active:scale-95 transition-all text-[10px] font-black uppercase tracking-widest">
                                    ...
                                    <button onClick={() => onEditOrder(order)} className="flex-1 min-w-[80px] flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-blue-600/10 text-blue-400 border border-blue-600/20 text-[10px] font-black uppercase tracking-widest active:scale-95 transition-all">
                                    ...
                                    <div className="relative flex-1 min-w-[140px]">
                                        <button 
                                            ...
                                            className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-purple-600/10 text-purple-400 border border-purple-600/20 text-[10px] font-black uppercase tracking-widest active:scale-95 transition-all"
                                        >
                                    ...
                                    {order.type === 'Offline' ? (
                                        <button onClick={() => onInitiateSettle(order)} className="flex-1 min-w-[100px] flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-lemon text-black text-[10px] font-black uppercase tracking-widest shadow-xl shadow-lemon/10 active:scale-95 transition-all">
                                        ...
                                        <button onClick={() => onCompleteOrder(order.id)} className="flex-1 min-w-[100px] flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-green-600 text-white text-[10px] font-black uppercase tracking-widest shadow-xl shadow-green-900/10 active:scale-95 transition-all">
